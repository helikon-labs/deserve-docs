...
The initial deployment covers Polkadot Asset Hub archive RPC and Ethereum-compatible RPC across 15 locations. Coverage is expanding to additional Polkadot system parachains, with Coretime currently rolling out.
