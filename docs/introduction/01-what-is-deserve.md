...
The initial deployment covers Polkadot Asset Hub archive RPC and Ethereum-compatible RPC across 14 locations. Coverage is expanding to additional Polkadot system parachains, with Coretime currently rolling out.

## Decentralization roadmap

DeServe is currently operated by [Helikon](https://helikon.io), a Polkadot-native infrastructure and software development team based in İstanbul. Cloud providers will be progressively replaced by native Polkadot infrastructure providers as the network matures, with governance, economics, and provider coordination moving on-chain.
